...
- [sdex](support/txbutler.go): The [Stellar Decentralized Exchange][sdex]
...
- [Strategy](trader/strategy/strategy.go) - API for a strategy used by the `trader` bot
...
- [Exchange](support/exchange/api/exchange.go#L30) - API for crypto exchanges
