...
- **strategy**: the strategy you want to run (_sell_, _buysell_, _balanced_, _swing_, _mirror_, _delete_).
...
- swing ([source](plugins/swingStrategy.go)):
...
- [Sample Swing strategy config file](examples/configs/trader/sample_swing.cfg)
