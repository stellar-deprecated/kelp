...
[Auth0][auth0] account required, to use auth0 authentication uncomment \[AUTH0] in [Sample GUI config file](examples/configs/trader/sample_sell.cfg) and enter the auth0 crendential in required fields.
